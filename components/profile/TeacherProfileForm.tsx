...
import WeeklyAvailability from './AvailabilityEditor';
    ...
    <div className="space-y-10">
        ...
        <form onSubmit={handleProfileSubmit} className="space-y-8">
            ...
            <AvailabilityEditor
                ...
                onAvailabilityChange={setCurrentAvailabilityJson} // <<< Update state with new JSON
            />
...
import React, { useState, useTransition, useCallback } from 'react';
import { useRouter } from 'next/navigation';
import type { TeacherProfile, Subject, TeacherSubject, TeacherStatus } from '@prisma/client';
...
export default function TeacherProfileForm({
 // userId,
  ...
  const handleAvailabilityUpdate = useCallback((newAvailabilityJson: any) => {
